...
function* init() {
  ...
  let config = {
    ...
    autoLogin: {
      key: 'alaska.uid',
      secret: random(32, { specials: true }),
      maxAge: 7 * 86400 * 1000
    },
  ...
  if (!util.isFile(dir + id + '.js')) {
    util.copyAndReplace(templateDir + 'start.js', dir + id + '.js', {
      ID: id
    });
  }
